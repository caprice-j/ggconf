...
If you change your `ggplot2::theme()` call into `ggconf::theme2()` call, ggconf would work.
...
(i.e. theme element names and theme configuration arguments),
`ggconf` tries to execute its best estimate
instead of bluntly returning an error.

For `theme2(ax.txt(sz=20, fc="bold"), ax.ln(col='gray60'), panel.bg(fill="white"))`,
